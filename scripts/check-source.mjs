...
const requiredFiles = [
  ...
  'src/main/preview-manager.ts',
  'src/main/preview-build.ts',
  'src/main/preview-runtime.ts',
  'src/main/instrumentation-map.ts',
  ...
  'src/renderer/src/components/PreviewPane.vue',
  'src/renderer/src/components/InputPanel.vue',
  'src/renderer/src/components/LibraryDialog.vue',
  'src/renderer/src/components/RunCompareDialog.vue',
  'src/renderer/src/components/ValueTree.vue',
  'src/renderer/src/composables/useDocumentSession.ts',
  'src/renderer/src/composables/useRunHistory.ts',
  'src/renderer/src/composables/useLabLibrary.ts',
  'src/renderer/src/composables/inputFormatting.ts'
]
