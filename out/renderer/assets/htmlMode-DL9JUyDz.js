...
import { H as HoverAdapter, D as DocumentHighlightAdapter, h as DocumentLinkAdapter, F as FoldingRangeAdapter, b as DocumentSymbolAdapter, S as SelectionRangeAdapter, c as RenameAdapter, f as DocumentFormattingEditProvider, g as DocumentRangeFormattingEditProvider, C as CompletionAdapter } from "./lspLanguageFeatures-U7wg3Zwq.js";
import { a, e, d, R, i, j, t, k } from "./lspLanguageFeatures-U7wg3Zwq.js";
import { l as languages } from "./App-Bk9MZEGI.js";
    ...
    if (!this._client) {
      this._worker = createWebWorker({
        ...
        createWorker: () => new Worker(new URL(
          /* @vite-ignore */
          "" + new URL("html.worker-7kbKj01a.js", import.meta.url).href,
          import.meta.url
        ), { type: "module" }),
