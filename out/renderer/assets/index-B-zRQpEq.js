const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./App-Bk9MZEGI.js","./App-WrnlullF.css"])))=>i.map(i=>d[i]);
...
async function bootstrapRenderer() {
  try {
    ...
    const { default: App } = await __vitePreload(async () => {
      const { default: App2 } = await import("./App-Bk9MZEGI.js").then((n) => n.A);
      return { default: App2 };
